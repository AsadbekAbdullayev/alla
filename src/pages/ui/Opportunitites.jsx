...
import kids from '@/assets/icons/kids2.svg';
import tree from '@/assets/icons/tree.svg';
import pupil from '@/assets/icons/pupil.svg';
...
const Opportunitites = () => {
	return (
		<div className="p-[120px] w-full flex flex-col items-center relative">
			...
			<img src={kids} alt="" className="absolute top-0 left-0" />
			<svg
			...
			<img src={pupil} alt="" className='absolute top-[226px] right-[160px]' />
		</div>
	);
};
