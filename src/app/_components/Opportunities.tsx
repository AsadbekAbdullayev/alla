...
const Opportunitites = () => {
  ...
  return (
    <div className={`p-[120px] w-full flex flex-col items-center relative ${isDark ? '' : 'bg-gradient-to-b from-[#C6D0F2] to-[#F2F6F5]'}`}>
      <div>
      ...
      <div className="flex flex-col items-center justify-center w-full space-y-[-35px] mt-[80px]">
        <div
          ...
          style={{
            background: isDark ? `url(${"/assets/icons/rectangle1.svg"})` : `url(${"/assets/icons/rectagle1Light.svg"})`,
            backgroundRepeat: "no-repeat",
          }}
        >
          <h2 className={`${isDark ? 'text-white' : 'text-[#3D3D3D]'} text-[48px] font-[900] leading-[60px] max-w-[251px] w-full mt-[64px]`}>
            <span className={isDark ? '' : 'text-[#89C423]'}>Ota-onalar</span> nazorati
          </h2>
          <div className="max-w-[270px] mt-[74px] h-[118px]">
            <p className={`${isDark ? 'text-white' : 'text-[#505050]'} text-[24px] font-[800] leading-[36px] `}>
              Yoshga mos tavsiyalar
            </p>
            <p className={`${isDark ? 'text-[#FFFFFFCC]' : 'text-[#505050CC]'} text-[16px] font-[600] pt-3`}>
        ...
        <div
          className="max-w-[1200px] w-full h-[282px] flex items-start gap-[30px] px-9 "
          style={{
            background: isDark ? `url(${"/assets/icons/rectangle2.svg"})` : `url(${"/assets/icons/rectangle2Light.svg"})`,
            backgroundRepeat: "no-repeat",
          }}
        >
          <h2 className={`${isDark ? 'text-white' : 'text-[#3D3D3D]'} text-[48px] font-[900] leading-[60px] max-w-[251px] w-full mt-[94px]`}>
		  <span className={isDark ? '' : 'text-[#89C423]'}>Raqamli</span> kutubxona
          </h2>
      ...
      />
      <svg
        className="absolute top-[97px] left-[250px]"
        width="112"
        height="108"
        viewBox="0 0 112 108"
        fill="none"
      ...
      <img
        ...
        alt=""
        className="absolute top-[226px] right-[160px]"
      />
    </div>
  );
};
