		...
		<div className="p-[120px] w-full flex flex-col items-center relative">
			...
			<div className="flex flex-col items-center justify-center w-full space-y-[-35px] mt-[80px]">
				<div
					...
					style={{
						background: `url(${'/assets/icons/rectangle1.svg'})`,
				...
				<div
					className="max-w-[1200px] w-full h-[282px] flex items-start gap-[30px] px-9 "
					style={{
						background: `url(${"/assets/icons/rectangle2.svg"})`,
						backgroundRepeat: 'no-repeat',
					}}
				>
			...
			<img src="/assets/icons/kids2.svg" alt="" className="absolute top-0 left-0" />
			<svg
			...
			<img src="/assets/icons/pupil.svg" alt="" className="absolute top-[226px] right-[160px]" />
		</div>
	);
};
